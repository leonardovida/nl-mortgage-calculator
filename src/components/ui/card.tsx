  ...
  return (
    <div
      ...
      className={cn(
        ...
        "shadow-sm shadow-slate-100 dark:shadow-slate-900/10",
        "py-8 transition-all duration-200",
        "hover:shadow-md hover:shadow-slate-200/60 dark:hover:shadow-slate-900/20",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("leading-tight font-semibold text-slate-900 dark:text-white text-xl tracking-tight", className)}
      {...props}
    />
  )
}
